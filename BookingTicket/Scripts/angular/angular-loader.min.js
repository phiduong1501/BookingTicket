...
(function () {
    ...
    function g(a, f) {
        ...
        return function () {
            var d = arguments[0], e;
            e = "[" + (a ? a + ":" : "") + d + "] http://errors.angularjs.org/1.6.4/" + (a ? a + "/" : "") + d;
        ...
        return f(a, "module", function () {
            ...
            return function (b, g, l) {
                ...
                return f(a, b, function () {
                    ...
                    if (!g)
                        throw d("nomod", b);
                    var f = [], k = [], n = [], p = a("$injector", "invoke", "push", k), h = { _invokeQueue: f, _configBlocks: k, _runBlocks: n, info: function (a) {
