...
(function (x, p) {
    ...
    function s(f, k) {
        ...
        this.$get = function () { return { ngClickOverrideEnabled: function () { return e; } }; };
    }
    function v(f, k, e) {
        n.directive(f, ["$parse", "$swipe", function (a, b) {
                return function (l, u, g) {
                    ...
                    var m = a(g[f]), d, r, c = ["touch"];
                    p.isDefined(g.ngSwipeDisableMouse) || c.push("mouse");
                    b.bind(u, { start: function (c, a) { d = c; r = !0; }, cancel: function (c) { r = !1; }, end: function (c, d) { h(c) && l.$apply(function () { u.triggerHandler(e); m(l, { $event: d }); }); } }, c);
                };
            }]);
    }
    var n = p.module("ngTouch", []);
    n.info({ angularVersion: "1.6.4" });
    n.provider("$touch", s);
    ...
    n.factory("$swipe", [function () {
            ...
            return { bind: function (a, b, l) {
                    var e, g, h, m, d = !1;
                    l = l || ["mouse", "touch", "pointer"];
                    a.on(k(l, "start"), function (c) { h = f(c); d = !0; g = e = 0; m = h; b.start && b.start(h, c); });
                    var r = k(l, "cancel");
                    if (r)
                        a.on(r, function (c) { d = !1; b.cancel && b.cancel(c); });
